    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <ProjectCard
          ...
          description="SkillForge AI is a GenAI-powered adaptive learning platform built using a Retrieval Augmented Generation (RAG) architecture. Users can paste study material or notes as text and ask contextual questions with difficulty-based control and multiple learning modes."
          tags={[
            "GenAI",
            "RAG",
            "LLM",
        ...
        <ProjectCard
          ...
          description="CVisionAI is an automated resume screening system that extracts structured data from PDFs and classifies candidates using ML models for faster hiring decisions."
          tags={[
            "Python",
            "TF-IDF",
            "KNN",
        ...
        <ProjectCard
          ...
          description="StyleSense uses deep learning (ResNet50) to extract visual features and recommend similar clothing items based on uploaded images."
          tags={[
            "TensorFlow",
            "ResNet50",
            "Deep Learning",
        ...
        <ProjectCard
          ...
          description="BrainFlash is an interactive web game designed to improve short-term memory with increasing difficulty levels and recall challenges."
          tags={[
            "React",
            "JavaScript",
            "Game Dev",
