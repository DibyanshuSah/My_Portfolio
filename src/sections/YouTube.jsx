...
const YouTube = () => {
  return (
    <section id="youtube" className="py-20 px-6 max-w-6xl mx-auto text-white">
      ...
      {}
      <div
        className="bg-[#111827] p-6 rounded-xl shadow-lg border border-blue-500 hover:border-blue-400 transition-all duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]">
        {}
        ...
        <a
          ...
          target="_blank"
          className="inline-block px-6 py-3 rounded-lg bg-green-600 hover:bg-green-700text-white font-semibold transition-all duration-200">
          Visit Channel
        </a>
      </div>
    </section>
