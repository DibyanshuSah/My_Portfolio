  ...
  return (
    <section 
      ...
      <div 
        ...
        {}
        <img src={profile} 
          className="w-52 h-52 md:w-56 md:h-56 rounded-full object-cover border-4 border-green-500 shadow-[0_0_25px_#00ff00]" alt="Profile"/>
        {/* ABOUT TEXT */}
        <div className="space-y-4 text-lg text-gray-300 leading-relaxed md:text-left text-center">
          <p>I’m an aspiring <strong className="text-blue-400">AI/ML Engineer</strong> and 
          ...
          <p>
            ...
            <strong className="text-blue-400"> Computer Vision</strong>, along with hands-on experience in 
            <strong className="text-blue-400"> Cybersecurity vulnerability assessment </strong> using frameworks like 
